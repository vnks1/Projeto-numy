...
import OrbitingIntegrations from "@/components/home/orbiting-integrations";
...
export function IntegrationsVisual() {
  return (
    <OrbitingIntegrations className="absolute inset-0 m-auto h-full w-full border-none bg-transparent backdrop-blur-none transition-all duration-300 ease-out group-hover:scale-105" />
  );
}
...
const FEATURES = [
  {
    ...
    tagClassName:
      "text-[14px] rounded-[8px] bg-zinc-100 border-zinc-100 shadow-none font-light text-zinc-800",
