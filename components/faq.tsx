...
const FAQ_ITEMS = [
  {
    ...
    answer: (
      <p className="text-[#4B5563] text-sm leading-relaxed">
        Não sem sua permissão. A Numa pode sugerir respostas e rascunhos, mas
        você sempre revisa e decide o que enviar. Você mantém total controle
  ...
  },
  {
    ...
    answer: (
      <p className="text-[#4B5563] text-sm leading-relaxed">
        Sim. A Numa processa suas mensagens de forma segura e não armazena o
        conteúdo das suas conversas além do necessário para o funcionamento. Sua
  ...
  },
  {
    ...
    answer: (
      <p className="text-[#4B5563] text-sm leading-relaxed">
        A Numa acessa apenas as conversas que você autorizar. Você pode escolher
        quais chats deseja que ela organize e monitore, mantendo total controle
        sobre o acesso.
      </p>
    ),
  },
