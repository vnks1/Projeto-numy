  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
        <div className="flex flex-col items-center gap-6 sm:gap-8 lg:grid lg:grid-cols-2 lg:items-center lg:gap-16">
          {/* Column 1 â€” Title (Left) */}
          <div className="flex w-full flex-col items-center text-center lg:items-start lg:text-left order-1">
            <motion.h1
            ...
            <motion.p
              ...
              className="mt-4 text-[#4B5563] text-base sm:text-lg leading-relaxed max-w-[400px]"
            >
            ...
            <motion.div
              ...
              className="mt-6 flex flex-col items-center lg:items-start gap-3 w-full"
            >
              <RainbowButton
                asChild
                variant="default"
          ...
          <div className="flex justify-center items-end order-2 relative mt-10 lg:mt-0">
            <motion.div
              ...
              className="relative z-10 w-full max-w-[350px] mx-auto"
            >
              <Image
                src="/iphone.png"
      ...
      <Marquee className="mt-7 sm:mt-8" aria-hidden="true">
        <MarqueeContent speed={30}>
          {INTEGRATION_PLATFORMS.map((platform) => (
            <MarqueeItem key={platform.id} className="mx-4 sm:mx-5">
              <PlatformBrandIcon platform={platform.id} className="h-6 w-6" />
            </MarqueeItem>
          ))}
        </MarqueeContent>

        <MarqueeFade side="left" className="w-12 sm:w-16" />
        <MarqueeFade side="right" className="w-12 sm:w-16" />
      </Marquee>
    </div>
  );
}
