    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 w-full h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center ml-auto">
          ...
          <Link
            href={WAITLIST_URL}
            className="inline-flex ml-8 items-center justify-center gap-1 rounded-[20px] border border-zinc-200 bg-zinc-50 px-4 py-2 text-sm font-medium text-zinc-900"
          >
            Garantir meu acesso
          </Link>
        </div>
